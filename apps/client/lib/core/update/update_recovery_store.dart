...
/// Guarda o marcador de "instalação pendente" do `desktop_updater` em disco,
/// pra ele saber (no próximo start) se um update em andamento terminou ou
/// falhou. Adaptado do `JsonFileUpdateRecoveryStore` de exemplo do próprio
/// pacote (repositório `desktop_updater`, `example/lib`).
